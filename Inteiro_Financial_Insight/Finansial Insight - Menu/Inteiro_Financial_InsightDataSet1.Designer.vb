...
Partial Public Class Inteiro_Financial_InsightDataSet1
    ...
    Partial Public Class Likviditetsbudget_Niveau_1_2_importDataTable
        ...
        Public Overloads Function AddLikviditetsbudget_Niveau_1_2_importRow( _
                    ...
                    ByVal S_beløb As Integer) As Likviditetsbudget_Niveau_1_2_importRow
            ...
            Dim columnValuesArray() As Object = New Object() {Løbenr, Dato, BrugerGruppe, Bruger, Version, Dim01, Dim01Value, Dim02, Dim02Value, Dim03, Dim03Value, Dim04, Dim04Value, Dim05, Dim05Value, Dim06, Dim06Value, Dim07, Dim07Value, Dim08, Dim08Value, Dim09, Dim09Value, Dim10, Dim10Value, Kommentar, S_beløb}
    ...
    Partial Public Class Likviditetsbudget_Niveau_1_2_importTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Likviditetsbudget_Niveau_1_2_import] ([Løbenr], [Dato], [Bruge"& _ 
                ...
                "im10], [Dim10Value], [Kommentar], [S_beløb]) VALUES (@Løbenr, @Dato, @BrugerGrup"& _ 
                "pe, @Bruger, @Version, @Dim01, @Dim01Value, @Dim02, @Dim02Value, @Dim03, @Dim03V"& _ 
                "alue, @Dim04, @Dim04Value, @Dim05, @Dim05Value, @Dim06, @Dim06Value, @Dim07, @Di"& _ 
                "m07Value, @Dim08, @Dim08Value, @Dim09, @Dim09Value, @Dim10, @Dim10Value, @Kommen"& _ 
                "tar, @S_beløb)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Løbenr, Dato, BrugerGruppe, Bruger, Version, Dim01, Dim01Value, Dim02, Dim"& _ 
                ...
                " Kommentar, S_beløb FROM dbo.Likviditetsbudget_Niveau_1_2_import"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As Inteiro_Financial_InsightDataSet1.Likviditetsbudget_Niveau_1_2_importDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As Inteiro_Financial_InsightDataSet1.Likviditetsbudget_Niveau_1_2_importDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As Inteiro_Financial_InsightDataSet1.Likviditetsbudget_Niveau_1_2_importDataTable = New Inteiro_Financial_InsightDataSet1.Likviditetsbudget_Niveau_1_2_importDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As Inteiro_Financial_InsightDataSet1.Likviditetsbudget_Niveau_1_2_importDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As Inteiro_Financial_InsightDataSet1) As Integer
        ...
        Public Overloads Overridable Function Insert( _
                    ...
                    ByVal Dim10Value As String,  _
                    ByVal Kommentar As String,  _
                    ByVal S_beløb As Global.System.Nullable(Of Integer)) As Integer
            Me.Adapter.InsertCommand.Parameters(0).Value = CType(Løbenr,Integer)
