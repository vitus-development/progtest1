...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("Inteiro_Financial_InsightDataSetLikviditetsbudgetcsvimport"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class Inteiro_Financial_InsightDataSetLikviditetsbudgetcsvimport
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As Inteiro_Financial_InsightDataSetLikviditetsbudgetcsvimport = CType(MyBase.Clone,Inteiro_Financial_InsightDataSetLikviditetsbudgetcsvimport)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "Inteiro_Financial_InsightDataSetLikviditetsbudgetcsvimport"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/Inteiro_Financial_InsightDataSetLikviditetsbudgetcsvimport.xsd"& _ 
            ""
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As Inteiro_Financial_InsightDataSetLikviditetsbudgetcsvimport = New Inteiro_Financial_InsightDataSetLikviditetsbudgetcsvimport()
    ...
    Partial Public Class Likviditetsbudget_Niveau_1_2_importDataTable
        ...
        Public Overloads Function AddLikviditetsbudget_Niveau_1_2_importRow( _
            ...
            Dim columnValuesArray() As Object = New Object() {Løbenr, Dato, BrugerGruppe, Bruger, Version, Dim01, Dim01Value, Dim02, Dim02Value, Dim03, Dim03Value, Dim04, Dim04Value, Dim05, Dim05Value, Dim06, Dim06Value, Dim07, Dim07Value, Dim08, Dim08Value, Dim09, Dim09Value, Dim10, Dim10Value, Kommentar, S_beløb, K_beløb}
...
Namespace Inteiro_Financial_InsightDataSetLikviditetsbudgetcsvimportTableAdapters
    ...
    Partial Public Class Likviditetsbudget_Niveau_1_2_importTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [Likviditetsbudget_Niveau_1_2_import] ([Løbenr], [Dato], [BrugerGrupp"& _ 
                "e], [Bruger], [Version], [Dim01], [Dim01Value], [Dim02], [Dim02Value], [Dim03], "& _ 
                "[Dim03Value], [Dim04], [Dim04Value], [Dim05], [Dim05Value], [Dim06], [Dim06Value"& _ 
                "], [Dim07], [Dim07Value], [Dim08], [Dim08Value], [Dim09], [Dim09Value], [Dim10],"& _ 
                " [Dim10Value], [Kommentar], [S_beløb], [K_beløb]) VALUES (@Løbenr, @Dato, @Bruge"& _ 
                "rGruppe, @Bruger, @Version, @Dim01, @Dim01Value, @Dim02, @Dim02Value, @Dim03, @D"& _ 
                "im03Value, @Dim04, @Dim04Value, @Dim05, @Dim05Value, @Dim06, @Dim06Value, @Dim07"& _ 
                ", @Dim07Value, @Dim08, @Dim08Value, @Dim09, @Dim09Value, @Dim10, @Dim10Value, @K"& _ 
                "ommentar, @S_beløb, @K_beløb)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT   Løbenr, Dato, BrugerGruppe, Bruger, Version, Dim01, Dim01Value, Dim02, D"& _ 
                ...
                "im09Value, Dim10, Dim10Value, Kommentar, S_beløb, K_beløb"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         Likvidit"& _ 
                "etsbudget_Niveau_1_2_import"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT Bruger, BrugerGruppe, Dato, Dim01, Dim01Value, Dim02, Dim02Value, Dim03, D"& _ 
                "im03Value, Dim04, Dim04Value, Dim05, Dim05Value, Dim06, Dim06Value, Dim07, Dim07"& _ 
                "Value, Dim08, Dim08Value, Dim09, Dim09Value, Dim10, Dim10Value, K_beløb, Komment"& _ 
                "ar, Løbenr, S_beløb, Version FROM Likviditetsbudget_Niveau_1_2_import WHERE (Løb"& _ 
                "enr = @Løbenr)"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As Inteiro_Financial_InsightDataSetLikviditetsbudgetcsvimport.Likviditetsbudget_Niveau_1_2_importDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As Inteiro_Financial_InsightDataSetLikviditetsbudgetcsvimport.Likviditetsbudget_Niveau_1_2_importDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As Inteiro_Financial_InsightDataSetLikviditetsbudgetcsvimport.Likviditetsbudget_Niveau_1_2_importDataTable = New Inteiro_Financial_InsightDataSetLikviditetsbudgetcsvimport.Likviditetsbudget_Niveau_1_2_importDataTable()
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As Inteiro_Financial_InsightDataSetLikviditetsbudgetcsvimport.Likviditetsbudget_Niveau_1_2_importDataTable, ByVal Løbenr As Global.System.Nullable(Of Integer)) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (Løbenr.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(Løbenr.Value,Integer)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As Inteiro_Financial_InsightDataSetLikviditetsbudgetcsvimport.Likviditetsbudget_Niveau_1_2_importDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As Inteiro_Financial_InsightDataSetLikviditetsbudgetcsvimport) As Integer
        ...
        Public Overloads Overridable Function Insert( _
            ...
            If (S_beløb.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(26).Value = CType(S_beløb.Value,Integer)
            Else
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As Inteiro_Financial_InsightDataSetLikviditetsbudgetcsvimport, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._likviditetsbudget_Niveau_1_2_importTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As Inteiro_Financial_InsightDataSetLikviditetsbudgetcsvimport, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._likviditetsbudget_Niveau_1_2_importTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As Inteiro_Financial_InsightDataSetLikviditetsbudgetcsvimport) As Integer
