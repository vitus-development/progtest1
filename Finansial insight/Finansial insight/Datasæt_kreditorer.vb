...
Public Class Datasæt_kreditorer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Finansial_Insight___Debitorrapport.Datasæt_kreditorer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDatasæt_kreditorer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Datasæt_kreditorer = New Datasæt_kreditorer()
        rpt.Site = Me.Site
        Return rpt
    End Function
